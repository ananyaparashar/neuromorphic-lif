...
Think of the neuron as a bucket:
* Vm (membrane voltage) = water level
* Input current = water flowing in
* Leak = small hole letting water out
* Threshold = a bell at a fixed height
* Spike = bell rings when water reaches it
* Reset = bucket is flushed
* Refractory = short rest before filling again
